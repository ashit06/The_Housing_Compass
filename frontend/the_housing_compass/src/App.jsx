    ...
    <>
      ...
      <header className="main-header">
        <div className="container header-container">
          <div className="logo">
            <Link to="/"><img src="/logo.png" alt="The Housing Compass Logo" /></Link>
            <span>The Housing Compass</span>
          </div>
          <Navigation />
        </div>
      </header>
      ...
      <footer className="main-footer">
        <div className="container footer-container">
          ...
          <div className="footer-section">
            <h3>About The Housing Compass</h3>
            <div className="section-separator"></div>
            <p>The Housing Compass uses cutting-edge artificial intelligence to help investors identify properties with high appreciation potential.</p>
          ...
          <div className="footer-section">
            ...
            <ul className="contact-info">
              ...
              <li>
                ...
                <span>info@thehousingcompass.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="footer-bottom container">
          <p>&copy; 2025 The Housing Compass. All rights reserved.</p>
        </div>
      </footer>
